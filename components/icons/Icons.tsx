...
export const PaperAirplaneIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const UserIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const ShieldCheckIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const UserGroupIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const ChatBubbleBottomCenterTextIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const SparklesIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const SunIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.243l-1.591 1.591M5.25 12H3m4.243-4.773L5.652 5.652M12 9a3 3 0 100 6 3 3 0 000-6z" />
    </svg>
);

export const MoonIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const ListBulletIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const PaperClipIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
        <path strokeLinecap="round" strokeLinejoin="round" d="m18.375 12.739-7.693 7.693a4.5 4.5 0 0 1-6.364-6.364l10.94-10.94A3 3 0 1 1 19.5 7.372L8.552 18.32a1.5 1.5 0 0 1-2.121-2.121l10.582-10.582" />
    </svg>
);

export const CloudArrowDownIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const IdentificationIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const MinusIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const DocumentTextIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const XMarkIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const PlayIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const TrashIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const BoltIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const StopIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const DocumentCheckIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const PlusIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const MagnifyingGlassIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
...
export const ChevronRightIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', title, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} {...rest}>
        {title && <title>{title}</title>}
